...
contract MultiCollateralRegistryTest is Test {
    ...
    function testFuzz_AddCollateral_ValidInputs(address token, uint256 rate, uint8 decimals) public {
    ...
    function testFuzz_GetValueInUnderlying_Calculation(uint256 amount, uint256 rate) public {
